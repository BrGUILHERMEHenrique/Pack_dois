              ...
              <TabelaRow key={funcionario.id}>
                ...
                <Tabela align="center" style={{minWidth: 150}}><TextoTr>{formataNumero(funcionario.telefone)}</TextoTr></Tabela>
                  <Tabela align="center" style={{minWidth: 150}}>
                    ...
                    >
                      <DateRangeIconRounded fontSize="small" style={{marginTop: '3px'}}/>
                    </ButtonIcon>
                  <ButtonIcon 
                    onClick={() => {
                  ...
                  >
                    <EditIcon  fontSize="small" style={{textAlign: 'center', marginTop: '3px'}}/>
                  </ButtonIcon>
                  <ButtonIconD
                    onClick={() => {
                  ...
                  >
                    <DeleteForeverIcon fontSize="small" style={{marginTop: '3px'}}/>                    
                  </ButtonIconD>
                </Tabela>
              </TabelaRow>
            ))}
